...
\section{Experimenteller Test von Lazzarini}
	...
	&= 8,367538 \cdot 10 ^{-3} \nonumber
	\end{align}
	oder schlechter für den Mittelwert. Die zu erwartende Genauigkeit für den Wert von $\pi$ ist dann:
	\begin{align}
	\Delta x &= \pi - \frac{2 \cdot x}{P + \Delta \mu} \\
	&= \pi - \frac{2 \cdot \frac{5}{6}}{\frac{1808}{3408} + 8,367538 \cdot 10 ^{-3}} \\ \nonumber
	&= 0.048781 \nonumber .
	\end{align}
	Das ist deutlich ungenauer als $\Delta x = 0,5 * 10^{-6}$, was sechs Nachkommastellen entsprechen würde.
	Die Genauigkeit von dem ermittelte Wert für $\pi$ von Lazzarini von 6 Nachkommastellen war also nicht zu erwarten.
	
	Dabei könnte es sich um bloßen Zufall handeln. Die merkwürdige Anzahl an Nadelwürfen ($3408$) ist aber besonders verdächtig. Sein Ergebnis entspricht exakt der auch zu diesem Zeitpunkt bekannten Approximation $\pi \approx \frac{355}{133}$.
	...
	\begin{equation}
	\frac{5}{3} \pi  \approx \frac{5}{3} \frac{355}{133} = \frac{113}{213}
	\end{equation}
	sein.
	Die Anzahl an Würfen ist genau ein ganzes Vielfaches des nenners:
	\begin{equation}
	16 \cdot 213 = 3048
	\end{equation}
