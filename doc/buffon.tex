...
\section*{Abstract}
	...
	Aus den Ergebnissen geht hervor, dass die hergeleiteten Formeln für die Intervallschätzung und den Parametertest zuverlässige Ergebnisse liefern. Zusätzlich wird auch das Testverfahren mithilfe von falschen Formeln überprüft.
	
	Schlussendlich wird ein historischer Versuch des Buffonschen Nadelproblems analysiert. Dieser wurde 1901 von Mario Lazzarini durchgeführt. Mit einer Intervallschätzung werden Zweifel an den von Lazzarini berichteten Ergebnissen begründet.
