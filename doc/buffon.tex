...
\section*{Abstract}
	...
	Hierfür wird das Buffonsche Nadelproblem als Zufallsexperiment eingeführt und als Simulation in Python realisiert.
	
	Aus den Ergebnissen geht hervor, dass die hergeleiteten Formeln für die Intervallschätzung und den Parametertest zuverlässige Ergebnisse liefern. Zusätzlich wird auch das Testverfahren durch das Testen von falschen Formeln überprüft.
	
	Schlussendlich wird ein historischer Versuch des Buffonschen Nadelproblems analysiert. Dieser wurde 1901 von Mario Lazzarini durchgeführt. Mit Hilfe der Intervallschätzung werden Zweifel an der Richtigkeit des Ergebnisses begründet.
